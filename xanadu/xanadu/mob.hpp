...
public:
	...
	// constructor
	Mob(Map *map, int monster_id, int object_id, short position_x, short position_y, short foothold, signed char stance, int max_hp, int max_mp, bool is_boss, bool is_map_mob, int);
